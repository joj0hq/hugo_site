...
date = "2023-06-19"
description = "I joined 10X in February 2023. Here I'll talk about what led to that and the reality after 4 months."
title = "I Joined 10X, and Then 4 Months Later..."
type = "post"
cover.image = "/images/2023-06-19.webp"
...
This article is the 14th day entry for the [10X 6th Anniversary Advent Calendar](https://10xall.notion.site/10X-6-6-6-30-23ba40d94ad14700b46a661cd045e968). Yesterday, BizDev's Terasaki-san published an article "[5 discoveries from meeting with over 100 retail companies](https://note.com/yuka_terasaki/n/ne59ee6afddbc)", so please read it as well.
...
![Value axes organized in Notion during job hunting 2](/images/join-10x/2.png)
...
![Value axes organized in Notion during job hunting](/images/join-10x/1.png)

## Why 10X?

The path to 10X started from a casual conversation with a senior from my previous job on the way to a distant sauna ([everyone's favorite The Sauna](https://lampinc.co.jp/nojiriko/sauna)) asking, "Is there a company where they create products focused on issues regardless of whether you're an engineer or biz?"

Through that senior's introduction, I got an opportunity for a casual meeting with 10X's [suumin](https://twitter.com/suuminbot), and was instantly strongly attracted to 10X's charm, thinking "The sincere attitude toward product development is great! I'm excited about a product that can become social infrastructure!"
...
While many other products can be bought online, I think it's a distorted state that only fresh foods continue to be purchased in physical stores. There's a huge market there, and I was excited about the business of creating future infrastructure in the online supermarket domain where there's nothing but room for growth. (Reference: [「Culture Deck」](https://speakerdeck.com/10xinc/zhu-shi-hui-she-10x-culture-deck?slide=11))

![Culture Deck](/images/join-10x/3.png)

### Organization: An organization that faces current issues with a long-term perspective

I was attracted to Yamoto-san's strong mindset reflected in product development, wanting to spend time and resources on "things that are valuable in the long term" rather than blindly creating businesses for short-term profits. (Reference: [「Because we know the difficulty of "10x". The feelings of "10X" embedded in the company name and mission」](https://10x.co.jp/blog/10xblog/10x-mission-and-company/))
...
I was attracted when I heard that both engineers and BizDev actually catch up on user voices in the field and create products, showing a real field sense of facing issues. (Reference: [10X Product Division / Engineering Division Introduction Document](https://speakerdeck.com/10xinc/10x-purodakutobu-men-shao-jie-zi-liao?slide=14))
...
![Value axes organized in Notion during job hunting](/images/join-10x/4.png)
...
Also, until recently, I was also working on a project to verify domain boundaries of teams to eliminate the increased load of context switching that comes with product complexity. (Reference: [Transition to domain-based development structure](https://product.10x.co.jp/entry/2023/04/28/080000))
...
![Horizontal deployment of good things](/images/join-10x/6.png)
...
![Getting better](/images/join-10x/7.png)
...
And 10X is recruiting members! Please also check out our [recruitment page](https://10x.co.jp/recruit/).

Tomorrow, QAE Broccoli ([@nihonbuson](https://twitter.com/nihonbuson)), who also helped me at my previous job, is scheduled to publish an article. Look forward to it!
